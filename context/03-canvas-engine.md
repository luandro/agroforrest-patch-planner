...
## Context Tips
- Hooks are composed hierarchically: orchestrators call lower-level hooks (gestures → viewport → renderer). Touch the orchestrator when altering cross-cutting behavior.
