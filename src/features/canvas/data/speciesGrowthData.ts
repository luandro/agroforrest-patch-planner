...
export const SPECIES_GROWTH_PROFILES: Record<string, SpeciesGrowthProfile> = {
  ...
  'manga': {
    ...
    dataPoints: [
      ...
      { months: 12, canopyRadius: 0.4, height: 1.8, lightPenetration: 88 },
      { months: 24, canopyRadius: 0.8, height: 3.5, lightPenetration: 80 },
      { months: 48, canopyRadius: 1.8, height: 7, lightPenetration: 60 },
      { months: 96, canopyRadius: 3.5, height: 12, lightPenetration: 35 },
  ...
  'jaca': {
    ...
    dataPoints: [
      { months: 0, canopyRadius: 0.1, height: 0.6, lightPenetration: 94 },
      { months: 6, canopyRadius: 0.4, height: 1.5, lightPenetration: 88 },
      { months: 18, canopyRadius: 1, height: 3.5, lightPenetration: 75 },
      { months: 36, canopyRadius: 2.2, height: 6, lightPenetration: 55 },
      { months: 72, canopyRadius: 4, height: 11, lightPenetration: 30 },
      { months: 144, canopyRadius: 6.5, height: 16, lightPenetration: 18 },
